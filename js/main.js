...
(function(){
  var DICT={
    ...
    "تصميم مطبخ":"Kitchen Design",
    "Creative3Design — مايو 2026 • 15 دقيقة قراءة":"Creative3Design — May 2026 • 15 min read",
    "المطبخ وحده يُشكّل ما بين 25% و35% من ميزانية التشطيب الإجمالية في معظم المشاريع التي نفذها فريق Creative3Design. هذه النسبة ليست مصادفة — المطبخ هو الفضاء الوحيد في المنزل الذي يجمع بين المتانة الهندسية والجمال البصري والوظيفة اليومية الشديدة في وقت واحد. دليلنا هذا يكشف كل ما تحتاج معرفته لاتخاذ قرارات صحيحة قبل الشروع في تصميم مطبخك.":"The kitchen alone accounts for between 25% and 35% of the total finishing budget in most projects delivered by the Creative3Design team. This proportion is no coincidence — the kitchen is the only space in the home that combines engineering durability, visual beauty, and intense daily function all at once. This guide reveals everything you need to know to make the right decisions before starting your kitchen design.",
    "المطبخ قلب البيت — لماذا يأخذ 25-35% من ميزانية التشطيب؟":"The kitchen is the heart of the home — why does it take 25–35% of the finishing budget?",
    "يتساءل كثير من العملاء لماذا يكلف المطبخ بهذا القدر مقارنة ببقية الفضاءات. الإجابة في طبيعة المطبخ نفسه: هو المساحة الوحيدة في المنزل التي تتعرض يومياً لثلاثة أعداء مختلفة في آن واحد — الحرارة العالية من الطهي والأجهزة، الرطوبة من البخار والغسيل، والاستخدام المكثف من الفتح والإغلاق المستمر. هذه المتطلبات تستوجب خامات خاصة وتصنيعاً دقيقاً يرفعان التكلفة بشكل طبيعي.":"Many clients wonder why the kitchen costs this much compared to other spaces. The answer lies in the nature of the kitchen itself: it is the only space in the home exposed daily to three different enemies at once — high heat from cooking and appliances, moisture from steam and washing, and intensive use from constant opening and closing. These demands require special materials and precise fabrication that naturally raise the cost.",
    "يُضاف إلى ذلك أن المطبخ يضم أعلى كثافة من الأعمال المتخصصة في المتر المربع الواحد: تمديدات كهربائية خاصة (220V و380V)، شبكات سباكة للمياه والصرف، تركيب غاز، تهوية ميكانيكية، إضاءة وظيفية — وكل ذلك فوق بعضه في مساحة تتراوح في معظم الأحيان بين 8 و16 متراً مربعاً.":"On top of that, the kitchen packs the highest density of specialized works per square meter: dedicated electrical wiring (220V and 380V), plumbing networks for water and drainage, gas installation, mechanical ventilation, and task lighting — all stacked together in an area that is most often between 8 and 16 square meters.",
    "توزيع ميزانية المطبخ النموذجي":"Typical kitchen budget breakdown",
    "الكابينت (أعلى + أسفل): 45-55% من ميزانية المطبخ":"Cabinets (upper + lower): 45–55% of the kitchen budget",
    "الكاونتر والحوض: 15-20%":"Countertop and sink: 15–20%",
    "الأجهزة المدمجة (فرن، هود، غسالة أطباق): 15-20%":"Built-in appliances (oven, hood, dishwasher): 15–20%",
    "أعمال الإنشاء (كهرباء، سباكة، بلاط، دهانات): 15-20%":"Construction works (electrical, plumbing, tiling, paint): 15–20%",
    "أشكال المطبخ وأيها الأنسب لمساحتك؟":"Kitchen layouts and which suits your space?",
    "اختيار شكل المطبخ هو القرار التصميمي الأول والأكثر أثراً على الوظيفة والتكلفة معاً. إليك مقارنة شاملة للأشكال الخمسة الأكثر شيوعاً في السوق المصري:":"Choosing the kitchen layout is the first and most impactful design decision for both function and cost. Here is a comprehensive comparison of the five most common layouts in the Egyptian market:",
    "الخطي (I-Shape) — للمساحات الضيقة أقل من 6م²":"Single-wall (I-Shape) — for narrow spaces under 6 m²",
    "المطبخ الخطي يضع جميع العناصر (أحواض، أجهزة، خزائن) على جدار واحد في صف واحد. هو الخيار الإلزامي للمساحات التي لا تتجاوز عرضها 2.5 متر، وهو شائع جداً في الشقق الصغيرة والاستوديو في مصر.":"The single-wall kitchen places all elements (sinks, appliances, cabinets) along one wall in a single row. It is the mandatory choice for spaces no wider than 2.5 meters, and is very common in small apartments and studios in Egypt.",
    "المميزات:":"Pros:",
    "العيوب:":"Cons:",
    "المساحة الأنسب:":"Best-suited area:",
    "متوسط تكلفة الكابينت:":"Average cabinet cost:",
    "L-Shape — الأكثر انتشاراً في مصر":"L-Shape — the most common in Egypt",
    "المطبخ على شكل حرف L يستغل جدارين متعامدين، مما يخلق زاوية تخزين واسعة وثلاثية وظيفية (مثلث العمل بين الثلاجة والحوض والموقد). هذا الشكل هو الأكثر مبيعاً في مصر لأنه يناسب معظم مساحات المطابخ المصرية الشائعة بين 8 و14 متراً مربعاً.":"The L-shaped kitchen uses two perpendicular walls, creating a wide corner of storage and a functional work triangle (between the fridge, sink, and stove). This layout is the best-seller in Egypt because it suits most common Egyptian kitchen areas between 8 and 14 square meters.",
    "U-Shape — لأكبر مساحة تخزين وأفضل وظيفية":"U-Shape — for maximum storage and best functionality",
    "المطبخ على شكل حرف U يستغل ثلاثة جدران متتالية، وهو يوفر أكبر قدر من مساحة العمل والتخزين في أي شكل مطبخ. في مصر، يُستخدم في الشقق الكبيرة والفيلات حيث يتجاوز عرض المطبخ 3 أمتار على الأقل في الاتجاهين.":"The U-shaped kitchen uses three consecutive walls and provides the greatest amount of work and storage space of any kitchen layout. In Egypt, it is used in large apartments and villas where the kitchen width exceeds at least 3 meters in both directions.",
    "الجزيرة (Island) — للمطابخ المفتوحة فوق 14م²":"Island — for open kitchens over 14 m²",
    "مطبخ الجزيرة يضيف منضدة وسطية مستقلة (Island) في مركز المطبخ المفتوح. هو الاختيار الراقي الأكثر انتشاراً في الكمبوندات الجديدة والفيلات، ويُحوّل المطبخ إلى فضاء اجتماعي وليس فقط مطبخاً وظيفياً.":"The island kitchen adds a freestanding central counter (island) in the center of the open kitchen. It is the upscale choice most common in new compounds and villas, turning the kitchen into a social space rather than just a functional kitchen.",
    "متوسط تكلفة الكابينت + الجزيرة:":"Average cabinet + island cost:",
    "الـ Galley (الممر) — للشقق الصغيرة والاستوديو":"Galley — for small apartments and studios",
    "مطبخ الممر يضع خزائن ومناضد العمل على جدارين متقابلين مع ممر ضيق بينهما (لا يقل عن 90 سم). هو الحل الذكي للمساحات الضيقة جداً أو المستطيلة التي لا تسمح بأي شكل آخر.":"The galley kitchen places cabinets and work counters on two facing walls with a narrow corridor between them (no less than 90 cm). It is the smart solution for very narrow or rectangular spaces that don't allow any other layout.",
    "مقارنة شاملة لخامات الكابينت — السعر والجودة والمتانة":"A comprehensive comparison of cabinet materials — price, quality, and durability",
    "الكابينت هو عمود فقرة المطبخ — ويُمثّل وحده نصف تكلفة المطبخ تقريباً. فهم الفرق بين الخامات المختلفة يُمكّنك من اتخاذ قرار مدروس يوازن بين الميزانية وطول العمر والمظهر.":"Cabinets are the backbone of the kitchen — and alone account for roughly half the kitchen's cost. Understanding the difference between materials lets you make an informed decision that balances budget, longevity, and appearance.",
    "الخامة":"Material",
    "السعر/م.ط":"Price/linear m",
    "مقاومة الرطوبة":"Moisture resistance",
    "العمر الافتراضي":"Lifespan",
    "المظهر":"Appearance",
    "التوصية":"Recommendation",
    "خشب صيني (حبوب)":"Chinese wood (chipboard)",
    "ضعيفة":"Poor",
    "3-5 سنوات":"3–5 years",
    "متوسط":"Average",
    "مؤقت فقط":"Temporary only",
    "MDF + وجه PVC":"MDF + PVC face",
    "متوسطة":"Medium",
    "6-10 سنوات":"6–10 years",
    "جيد":"Good",
    "للميزانيات المحدودة":"For limited budgets",
    "HDF + وجه Acrylic":"HDF + Acrylic face",
    "جيدة":"Good",
    "10-15 سنة":"10–15 years",
    "ممتاز":"Excellent",
    "الخيار الأمثل للأغلبية":"The optimal choice for most",
    "HDF + وجه Lacquer":"HDF + Lacquer face",
    "جيدة جداً":"Very good",
    "12-18 سنة":"12–18 years",
    "فاخر":"Luxurious",
    "للمشاريع المتميزة":"For premium projects",
    "ألومنيوم عالي الجودة":"High-quality aluminum",
    "ممتازة":"Excellent",
    "20+ سنة":"20+ years",
    "عصري":"Modern",
    "للساحل أو بيئات الرطوبة":"For the coast or humid environments",
    "خشب طبيعي مستورد":"Imported natural wood",
    "متوسطة (يحتاج معالجة)":"Medium (needs treatment)",
    "15-25 سنة":"15–25 years",
    "كلاسيكي فاخر":"Luxurious classic",
    "للفيلات وبنتهاوس فقط":"For villas and penthouses only",
    "لماذا HDF + Acrylic هو الخيار الأمثل للأغلبية؟":"Why is HDF + Acrylic the optimal choice for most?",
    "في خبرة Creative3Design مع 400+ مطبخ منفذ في السنوات الخمس الأخيرة، خيار HDF بوجه Acrylic يحقق أفضل توازن: الكثافة العالية تجعله أقل تأثراً بالرطوبة والحرارة مقارنة بـ MDF، والوجه Acrylic يعطي لمسة عصرية لامعة أو مطفأة، سهل التنظيف ومقاوم للخدش بشكل معقول، وعمره يصل إلى 15 سنة مع الاستخدام الطبيعي.":"In Creative3Design's experience with 400+ kitchens delivered over the past five years, HDF with an Acrylic face achieves the best balance: its high density makes it less affected by moisture and heat than MDF, the Acrylic face gives a modern glossy or matte finish, it is easy to clean and reasonably scratch-resistant, and it lasts up to 15 years with normal use.",
    "متى تختار الألومنيوم؟":"When should you choose aluminum?",
    "الألومنيوم هو الخيار الأمثل في ثلاث حالات محددة: إذا كنت في منطقة ساحلية ذات رطوبة عالية (الإسكندرية، السواحل الشمالية)، إذا كان المطبخ يعمل بكثافة عالية لفترات طويلة (تجاري أو عائلة كبيرة)، أو إذا كنت تبحث عن استثمار طويل الأمد لا تريد إعادته خلال 20 سنة. لكن تجنب الألومنيوم الرخيص — هناك فارق شاسع بين ألومنيوم 15,000 ج.م/م.ط وألومنيوم 5,000 ج.م/م.ط من حيث سماكة الملف والإكسسوارات.":"Aluminum is the optimal choice in three specific cases: if you are in a coastal area with high humidity (Alexandria, the North Coast), if the kitchen operates intensively for long periods (commercial or a large family), or if you are looking for a long-term investment you don't want to redo within 20 years. But avoid cheap aluminum — there is a vast difference between aluminum at EGP 15,000/linear m and aluminum at EGP 5,000/linear m in terms of profile thickness and accessories.",
    "خيارات الكاونتر — المقارنة الشاملة بالأسعار":"Countertop options — a comprehensive price comparison",
    "الكاونتر هو سطح العمل الرئيسي في المطبخ — وهو يتعرض يومياً للحرارة والقطع والرطوبة والمواد الكيميائية. اختياره يوازن بين الجماليات والمتانة والتكلفة.":"The countertop is the main work surface in the kitchen — exposed daily to heat, cutting, moisture, and chemicals. Choosing it balances aesthetics, durability, and cost.",
    "الجرانيت المحلي: 300 - 600 ج.م/م²":"Local granite: EGP 300–600/m²",
    "الجرانيت المحلي المصري هو الأكثر انتشاراً في السوق، ولأسباب وجيهة. هو طبيعي 100%، متين للغاية، مقاوم للحرارة المباشرة، ومقاوم للخدش. اللون الأكثر توفراً محلياً هو الأسود أو الرمادي أو البيج. عيبه الوحيد أنه مسامي قليلاً ويحتاج تنظيفاً فورياً للبقع الحمضية كعصير الليمون أو الطماطم.":"Local Egyptian granite is the most common in the market, for good reasons. It is 100% natural, extremely durable, resistant to direct heat, and scratch-resistant. The most locally available colors are black, gray, or beige. Its only drawback is that it is slightly porous and needs immediate cleaning of acidic stains like lemon or tomato juice.",
    "التوصية:":"Recommendation:",
    "الرخام المستورد: 800 - 2,000 ج.م/م²":"Imported marble: EGP 800–2,000/m²",
    "رخام Carrara الإيطالي الأبيض أو رخام Marquina الأسود يُضفيان فخامة لا تُضاهى على المطبخ. لكن الرخام مسامي جداً، يُلطَّخ بسهولة بالعصائر والزيت والكيتشاب، ويحتاج تلميعاً وحماية دورية (كل 1-2 سنة). في المطابخ المصرية عالية الاستخدام، الرخام خيار جمالي يحتاج التزاماً بالعناية.":"White Italian Carrara marble or black Marquina marble lend unmatched luxury to the kitchen. But marble is very porous, stains easily from juices, oil, and ketchup, and needs periodic polishing and protection (every 1–2 years). In high-use Egyptian kitchens, marble is an aesthetic choice that requires a commitment to care.",
    "الكوريان (Corian): 600 - 1,200 ج.م/م²":"Corian: EGP 600–1,200/m²",
    "الكوريان هو مادة صناعية صلبة (Solid Surface) تجمع بين الأكريليك والمواد المعدنية. مميزاته الفريدة: لا درزات (يُلحَم حرارياً فيبدو قطعة واحدة)، قابل للتشكيل بأي شكل منحنيات وحواف دائرية، وسهل الإصلاح — الخدش يُزال بالصنفرة ببساطة. هو الخيار المفضل للمطابخ العصرية المنحنية أو التي يُراد لها مظهر متكامل بدون فواصل.":"Corian is a solid synthetic surface (Solid Surface) that combines acrylic with mineral materials. Its unique advantages: no seams (it is heat-welded to look like a single piece), can be shaped into any curves and rounded edges, and is easy to repair — scratches are simply sanded out. It is the preferred choice for modern curved kitchens or those wanting a seamless, integrated look.",
    "SPC / بورسلان: 250 - 500 ج.م/م²":"SPC / Porcelain: EGP 250–500/m²",
    "بعض المطابخ الاقتصادية تعتمد بورسلان أو حجر كوارتز مضغوط كسطح عمل. الجمال: سعر منخفض جداً، مقاوم للخدش، سهل التنظيف. العيوب: يحتاج درزات عند الربط، أطراف قابلة للكسر عند السقوط، مظهر أقل دفئاً من الجرانيت الطبيعي.":"Some economy kitchens use porcelain or compressed quartz stone as the work surface. Pros: very low price, scratch-resistant, easy to clean. Cons: needs seams at joints, edges prone to chipping if dropped, and a less warm appearance than natural granite.",
    "نوع الكاونتر":"Countertop type",
    "السعر/م²":"Price/m²",
    "مقاومة الحرارة":"Heat resistance",
    "مقاومة الخدش":"Scratch resistance",
    "العناية المطلوبة":"Required care",
    "جرانيت محلي":"Local granite",
    "منخفضة":"Low",
    "رخام مستورد":"Imported marble",
    "عالية":"High",
    "كوريان (Corian)":"Corian",
    "جيدة (لا يتحمل ما فوق 180°)":"Good (can't withstand above 180°)",
    "متوسطة (قابل للإصلاح)":"Medium (repairable)",
    "كوارتز مهندس":"Engineered quartz",
    "بورسلان / SPC":"Porcelain / SPC",
    "منخفضة جداً":"Very low",
    "جدول أسعار مطبخ كامل في مصر 2026 — حسب الخامة والمستوى":"Full kitchen price table in Egypt 2026 — by material and level",
    "الجدول التالي يوضح تكلفة مطبخ كامل (كابينت علوي وسفلي + كاونتر + تركيب) لمطبخ L-shape بطول 6 أمتار طولية (3 أمتار × 2 جدار) — وهو المقاس الأكثر شيوعاً في مصر:":"The following table shows the cost of a complete kitchen (upper and lower cabinets + countertop + installation) for an L-shaped kitchen of 6 linear meters (3 meters × 2 walls) — the most common size in Egypt:",
    "المستوى":"Level",
    "الكابينت":"Cabinet",
    "الكاونتر":"Countertop",
    "تكلفة الكابينت":"Cabinet cost",
    "تكلفة الكاونتر":"Countertop cost",
    "الإجمالي التقريبي":"Approximate total",
    "اقتصادي":"Economy",
    "خشب صيني + PVC":"Chinese wood + PVC",
    "بورسلان":"Porcelain",
    "كوريان أو كوارتز":"Corian or quartz",
    "HDF + Lacquer أو ألومنيوم":"HDF + Lacquer or aluminum",
    "رخام مستورد أو كوريان":"Imported marble or Corian",
    "ملاحظة: الأسعار لا تشمل الأجهزة المدمجة (فرن، هود، غسالة أطباق) ولا أعمال الكهرباء والسباكة والبلاط.":"Note: prices do not include built-in appliances (oven, hood, dishwasher) or electrical, plumbing, and tiling works.",
    "الحلول الذكية للمطابخ الصغيرة — استغلال كل سنتيمتر":"Smart solutions for small kitchens — using every centimeter",
    "أكثر من 40% من مطابخ الشقق المصرية تقع في نطاق 6-10 أمتار مربعة. إليك الحلول الذكية التي ثبتت فاعليتها في مشاريع Creative3Design:":"More than 40% of Egyptian apartment kitchens fall in the 6–10 square meter range. Here are the smart solutions that have proven effective in Creative3Design projects:",
    "استغلال الارتفاع الكامل — من الأرض للسقف":"Using full height — floor to ceiling",
    "أكثر ما يُهدَر في المطابخ الصغيرة هو المساحة بين أعلى الخزائن العلوية والسقف. بتصميم خزائن تصل للسقف (Floor-to-Ceiling) تربح مساحة تخزين إضافية 30-40% دون إضافة متر واحد. الخزائن العليا تُخصَّص للأغراض غير المتكررة (أواني المناسبات، المخزونات الزائدة).":"The most wasted space in small kitchens is between the top of the upper cabinets and the ceiling. By designing floor-to-ceiling cabinets you gain 30–40% extra storage without adding a single meter. The top cabinets are reserved for infrequently used items (occasion dishware, surplus stock).",
    "الرف المفتوح بدلاً من الخزانة العلوية في منطقة":"Open shelving instead of an upper cabinet in one area",
    "استبدال خزانة أو اثنتين علويتين برفوف مفتوحة يعطي المطبخ الصغير شعوراً بالاتساع البصري ويسهّل الوصول للأغراض اليومية. الرفوف المفتوحة تُكلّف 60% أقل من الخزائن المغلقة.":"Replacing one or two upper cabinets with open shelves gives a small kitchen a sense of visual spaciousness and makes everyday items easier to reach. Open shelves cost 60% less than closed cabinets.",
    "الجزيرة المتحركة (Mobile Island)":"Mobile island",
    "في المطابخ التي تتراوح بين 8 و12 متراً مربعاً، الجزيرة المتحركة على عجلات تُضيف مساحة عمل إضافية عند الحاجة وتُطوى جانباً عند عدم الاستخدام. تكلفتها 4,000-8,000 ج.م مقارنة بـ 20,000+ للجزيرة الثابتة.":"In kitchens between 8 and 12 square meters, a mobile island on wheels adds extra work space when needed and folds aside when not in use. It costs EGP 4,000–8,000 compared to 20,000+ for a fixed island.",
    "الدراوير العميقة بدلاً من الرفوف السفلية":"Deep drawers instead of lower shelves",
    "تحويل خزائن الجزء السفلي من رفوف إلى دراوير عميقة يُضاعف إمكانية الوصول ويُقلل الفوضى. الدراور العميق يسمح برؤية ما بداخله دفعة واحدة بدلاً من أن تنحني وتبحث خلف الأغراض في الخزانة.":"Converting lower cabinets from shelves to deep drawers doubles accessibility and reduces clutter. A deep drawer lets you see everything inside at once instead of bending down and searching behind items in the cabinet.",
    "بلاط الحائط حتى السقف في جانب الموقد":"Wall tiling up to the ceiling on the stove side",
    "تبليط الجدار خلف الموقد وصولاً للسقف يُجنّب تلف الطلاء بالدهون والبخار، ويُعطي المطبخ الصغير حجماً بصرياً أكبر مع تقليل تكاليف الصيانة.":"Tiling the wall behind the stove up to the ceiling prevents paint damage from grease and steam, and gives a small kitchen a larger visual volume while reducing maintenance costs.",
    "الأخطاء الشائعة في تصميم المطبخ — تجنبها قبل التنفيذ":"Common kitchen design mistakes — avoid them before execution",
    "من أكثر الأخطاء التصميمية التي يرصدها فريق Creative3Design في المطابخ المنفذة مسبقاً:":"Among the most common design mistakes the Creative3Design team observes in previously executed kitchens:",
    "الخطأ الأول: كسر مثلث العمل":"Mistake one: breaking the work triangle",
    "مثلث العمل (Thalaatha) هو المسافة الوظيفية بين الثلاجة والحوض والموقد. إجمالي المسافة بين الثلاثة يجب أن يكون بين 4 و8 أمتار — أقل من ذلك يخلق ازدحاماً، وأكثر يُتعب الطاهي. وضع الثلاجة في زاوية بعيدة عن المطبخ أو فصلها بجزء من الحائط يكسر هذا المثلث ويُفقد المطبخ كفاءته.":"The work triangle is the functional distance between the fridge, sink, and stove. The total distance between the three should be between 4 and 8 meters — less than that creates congestion, and more tires the cook. Placing the fridge in a corner far from the kitchen, or separating it with part of a wall, breaks this triangle and robs the kitchen of its efficiency.",
    "الخطأ الثاني: نسيان الإضاءة الوظيفية":"Mistake two: forgetting task lighting",
    "الإضاءة العامة للسقف لا تكفي في المطبخ — تحتاج إضاءة تحت الخزائن العلوية مباشرةً فوق سطح العمل. كثير من المطابخ المصرية تُنفَّذ بدون هذه الإضاءة ثم يعاني الساكن من ظلال يلقيها جسده على سطح التقطيع والطهي.":"General ceiling lighting is not enough in the kitchen — you need lighting directly under the upper cabinets, above the work surface. Many Egyptian kitchens are built without this lighting, and the resident then suffers from shadows cast by their own body onto the cutting and cooking surface.",
    "الخطأ الثالث: التهوية غير الكافية":"Mistake three: inadequate ventilation",
    "شفاط المطبخ (Hood) يجب أن يكون بقوة شفط لا تقل عن 3 مرات حجم المطبخ في الساعة. شفاط ضعيف يعني: روائح تنتشر في الشقة، رطوبة تراكمية تُتلف الخزائن والجدران، وبقع دهون صعبة الإزالة على الجدران والأسقف.":"The kitchen hood should have an extraction power of no less than 3 times the kitchen's volume per hour. A weak hood means: odors spreading through the apartment, cumulative humidity that damages cabinets and walls, and stubborn grease stains on walls and ceilings.",
    "الخطأ الرابع: خزائن الزاوية بدون حل":"Mistake four: corner cabinets with no solution",
    "زاوية المطبخ في الـ L-shape أو U-shape تُهدَر إذا لم يكن فيها حل تخزين مدروس. أفضل الحلول: Lazy Susan (رف دوار)، أو Corner Pullout، أو Magic Corner. تجاهل الزاوية يُضيّع 20-30% من مساحة التخزين الكلية.":"The kitchen corner in an L-shape or U-shape is wasted if it has no thoughtful storage solution. The best solutions: a Lazy Susan (rotating shelf), a corner pullout, or a Magic Corner. Ignoring the corner wastes 20–30% of total storage space.",
    "الخطأ الخامس: التوفير في نوعية الإكسسوارات":"Mistake five: skimping on accessory quality",
    "المفصلات والسكك (Hinges and Slides) هي \"قلب\" المطبخ الميكانيكي. استخدام مفصلات رخيصة مجهولة الماركة يعني بعد 2-3 سنوات: أبواب منحرفة، صوت إغلاق مزعج، وتلف متسارع. المفصلات الإيطالية (Blum, Hettich, Grass) تُكلّف 30-50% أكثر لكنها تُؤمّن عمراً 20 سنة مقارنة بـ5 سنوات للرخيصة.":"Hinges and slides are the mechanical 'heart' of the kitchen. Using cheap, unbranded hinges means, after 2–3 years: misaligned doors, an annoying closing sound, and accelerated wear. Italian hinges (Blum, Hettich, Grass) cost 30–50% more but secure a 20-year lifespan compared to 5 years for cheap ones.",
    "نصمم مطبخك من الفكرة إلى التسليم":"We design your kitchen from concept to handover",
    "Creative3Design تُقدم تصميم مطبخ ثلاثي الأبعاد مجاناً مع عرض السعر — لترى مطبخك قبل تنفيذه بالكامل":"Creative3Design offers a free 3D kitchen design with the quote — so you see your kitchen before it's fully built",
    "احصل على تصميم مجاني":"Get a free design",
    "احسب تكلفة مطبخك":"Calculate your kitchen cost",
    "الأسئلة الأكثر شيوعاً عن تصميم المطبخ في مصر":"Most frequently asked questions about kitchen design in Egypt",
    "كم سعر المتر الطولي للمطبخ في مصر 2026؟":"What is the price per linear meter for a kitchen in Egypt 2026?",
    "3,500 ج.م للخشب الصيني الاقتصادي":"EGP 3,500 for economy Chinese wood",
    "5,000-8,000 ج.م للـ MDF بوجه PVC":"EGP 5,000–8,000 for MDF with a PVC face",
    "8,000-14,000 ج.م للـ HDF بوجه Acrylic":"EGP 8,000–14,000 for HDF with an Acrylic face",
    "15,000-25,000 ج.م للألومنيوم عالي الجودة":"EGP 15,000–25,000 for high-quality aluminum",
    "ما هو أفضل شكل مطبخ للمساحات الصغيرة في مصر؟":"What is the best kitchen layout for small spaces in Egypt?",
    "المطبخ الخطي (I-shape)":"The single-wall kitchen (I-shape)",
    "ما الفرق بين مطبخ HDF ومطبخ MDF؟":"What is the difference between an HDF kitchen and an MDF kitchen?",
    "HDF (High-Density Fiberboard) أكثف وأصلب وأقل قابلية لامتصاص الرطوبة":"HDF (High-Density Fiberboard) is denser, stronger, and less prone to absorbing moisture",
    "هل مطبخ الألومنيوم أفضل من الخشب في مصر؟":"Is an aluminum kitchen better than wood in Egypt?",
    "مقاومة الرطوبة والحشرات بشكل كامل، العمر الافتراضي الطويل (20+ سنة)":"Full resistance to moisture and insects, and a long lifespan (20+ years)",
    "ما هو أفضل كاونتر مطبخ في مصر من حيث السعر والجودة؟":"What is the best kitchen countertop in Egypt in terms of price and quality?",
    "الجرانيت المحلي بسعر 300-600 ج.م/م²":"Local granite at EGP 300–600/m²",
    "أعمالنا المنفذة":"Our completed work",
    "مقالات ذات صلة":"Related articles",
    "عقد التشطيب — 12 بنداً إلزامياً":"The finishing contract — 12 mandatory clauses",
    "كيف تتحكم في ميزانية التشطيب 2026":"How to control the finishing budget 2026",
    "أخطاء التصميم الداخلي الشائعة":"Common interior design mistakes",
    "دليل تشطيب الشقق في مصر 2026":"Guide to apartment finishing in Egypt 2026",
    "تصميم مطبخ مجاناً":"Free kitchen design",
    "تصميم ثلاثي الأبعاد مجاناً مع عرض السعر":"Free 3D design with the quote",
    "ابدأ المحادثة":"Start the conversation",
    "احسب تكلفة مطبخك فوراً":"Calculate your kitchen cost instantly",
    "الحاسبة التفاعلية":"The interactive calculator",
    "تصفح مشاريع المطابخ المنفذة":"Browse completed kitchen projects",
    "واصل القراءة":"Keep reading",
    "حماية قانونية":"Legal protection",
    "عقد التشطيب — 12 بنداً لا تقبل مشروعاً بدونها":"The finishing contract — 12 clauses you should never accept a project without",
    "البنود الجوهرية التي تحمي أموالك وتضمن الجودة والمواعيد في أي عقد تشطيب.":"The essential clauses that protect your money and guarantee quality and timelines in any finishing contract.",
    "كيف تتحكم في ميزانية التشطيب وتتجنب التجاوزات":"How to control the finishing budget and avoid overruns",
    "منهجية واضحة لبناء ميزانية تشطيب محكمة وتجنب الصدمات المالية في مصر 2026.":"A clear methodology for building a tight finishing budget and avoiding financial shocks in Egypt 2026.",
    "أخطاء التصميم الداخلي الشائعة وكيف تتجنبها":"Common interior design mistakes and how to avoid them",
